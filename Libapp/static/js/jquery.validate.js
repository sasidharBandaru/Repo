...
$.extend($.validator, {
	...
	messages: {
		...
		isalpha: "Please enter only alphabets.",
		...
		init: function() {
			...
			$(this.currentForm)
				.validateDelegate(":text, [type='password'], [type='file'], select, textarea, " +
					...
					"[type='range'], [type='color'], [type='isalpha'], [type='phoneUS'] ",
	...
	methods: {
		...
		isalpha: function( value, element ) {
		...
		phoneUS: function( value, element ) {
			return this.optional(element) || value.length > 9 && /^(?:\(\d{3}\)|\d{3})(?: *- *)?\d{3}(?: *- *)?\d{4}$/.test(value);
		},
